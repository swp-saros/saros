...
import static saros.versioning.Compatibility.MISMATCHED_DEV_BUILD;
...
public class Version {
   ...
   */
  public Compatibility determineCompatibilityWith(Version other) {
    ...
    if (!this.qualifier.isEmpty() || !other.qualifier.isEmpty()) {
      return this.hasSameVersionNumber(other) ? OK : MISMATCHED_DEV_BUILD;
    }
